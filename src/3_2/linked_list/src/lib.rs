...
mod tests {
    ...
    // 現状、ノードが一つもないとき、remove_from_index(0)はエラーなしで、remove_from_index(1)はエラーになる。挙動に一貫性がない。でもout of indexという意味では0のときエラーにならなくて正解か？
    #[test]
//    #[should_panic(expected = "Out of index. index値が大きすぎます。index: 1")]
    #[should_panic(expected = "Out of index. index値が大きすぎます。index: 1, 許容範囲: 0...0")]
//    #[should_panic(expected = "Out of index. index値が大きすぎます。")]
